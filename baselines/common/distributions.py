...
def make_pdtype(ac_space):
    ...
    if isinstance(ac_space, spaces.Box) or isinstance(ac_space, rllab_spaces.Box):
        assert len(ac_space.shape) == 1
        return DiagGaussianPdType(ac_space.shape[0])
    elif isinstance(ac_space, spaces.Discrete) or isinstance(ac_space, rllab_spaces.Discrete):
