...
plt.title('half-cheetah, goal velocity', fontsize=26)
#plt.ylim([-0.04, 3.5])
plt.tight_layout()
...
if  legend:
    plt.savefig('cheetah_results.png', bbox_extra_artists=(lgd,), transparent=True, bbox_inches='tight')
else:
    plt.savefig('cheetah_results.png', bbox_inches='tight')
