...
# from rllab.envs.half_cheetah_gym_env import HalfCheetahGymEnv
from rllab.envs.mujoco.half_cheetah_env_rand_test import HalfCheetahEnvRand
...
for task_num in range(1):
    ...
    #     n_parallel=1,
    #     snapshot_mode="last",
    #     exp_name="TRPO_test_goalvel_cheetah_rllab" + str(task_num) + 'seed' + str(20),
    #     exp_prefix="TRPO_test_goalvel_cheetah_rllab",
    #     seed=20
    # )
    algo.train()