...
from sandbox.ours.bad_model_exps.ModelTRPO.model_trpo import ModelTRPO
from experiments.helpers.run_multi_gpu import run_multi_gpu
from sandbox.ours.envs.mujoco import AntEnvRandParams, HalfCheetahEnvRandParams, HopperEnvRandParams, SwimmerEnvRandParams, \
...
EXP_PREFIX = 'model-ensemble-trpo-bad-models'
