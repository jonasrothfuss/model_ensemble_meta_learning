...
EXP_PREFIX = 'model-ensemble-maml-meta-batch'
...
def instantiate_class_stings(v):
    v['env'] = globals()[v['env']]
    v['meta_batch_size'] = v['meta_batch_sample_tuple'][0]
    v['batch_size_env_samples'] = v['meta_batch_sample_tuple'][1]
    v['batch_size_dynamics_samples'] = v['meta_batch_sample_tuple'][2]
