from rllab_maml.misc.console import colorize
import inspect
...
def _get_prefix(cls):
    from rllab_maml.mdp.base import MDP
    from rllab_maml.policies.base import Policy
    from rllab_maml.baselines.base import Baseline
    from rllab_maml.algos.base import Algorithm
