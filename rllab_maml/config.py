...
AWS_SECURITY_GROUPS = ["rllab_maml"]
...
DOCKER_CODE_DIR = "/root/code/rllab_maml"
...
if osp.exists(osp.join(osp.dirname(__file__), "config_personal.py")):
    ...
    copy(osp.join(PROJECT_PATH, "rllab_maml/config_personal_template.py"), osp.join(PROJECT_PATH, "rllab_maml/config_personal.py"))
    from .config_personal import *
