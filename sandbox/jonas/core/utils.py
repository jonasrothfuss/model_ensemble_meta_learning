...
def make_dense_layer_with_bias_transform(input_shape, num_units, name='fc', W=L.XavierUniformInitializer(), b=tf.zeros_initializer, bias_transform=tf.zeros_initializer, weight_norm=False, **kwargs):
    # make parameters
