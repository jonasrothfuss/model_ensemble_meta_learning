...
from sandbox.jonas.core.utils import make_dense_layer_with_bias_transform, forward_dense_bias_transform, make_dense_layer
...
class MAMLImprovedGaussianMLPPolicyParamNoise(StochasticPolicy, Serializable):
    def __init__(
            self,
            name,
            env_spec,
        ...
        with tf.variable_scope(self.name):
            ...
            if std_network is not None:
                ...
                super(MAMLImprovedGaussianMLPPolicyParamNoise, self).__init__(env_spec)
