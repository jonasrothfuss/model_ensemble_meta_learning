...
from sandbox.ignasi.algos.optimizers.noisy_adam import NoisyAdamOptimizer
import sandbox.rocky.tf.core.layers as L
import joblib


class BayesianDynamics(LayersPowered, Serializable):
    ...
    def __init__(self,
        ...
        with tf.variable_scope(name):
            ...
            self.mu, self.cov = self.optimizer.minimize(self.loss)
        ...
        for epoch in range(epochs):
            ...
            while True:
                try:
                    ...
                    if verbose:
                        logger.log("Training NNDynamicsModel - finished epoch {} -- mean loss: {}".format(epoch,
                                                                                                          np.mean(
                                                                                                              batch_losses)))
                    break
