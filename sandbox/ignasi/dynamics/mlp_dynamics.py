...
class MLPDynamicsModel(LayersPowered, Serializable):
    ...
    def __init__(self,
        ...
        with tf.variable_scope(name):
            ...
            self.loss = tf.reduce_mean([tf.nn.l2_loss(self.delta_ph - delta_pred)
        ...
        LayersPowered.__init__(self, self.delta_pred)
    ...
    def fit(self, obs, act, obs_next, epochs=50, compute_normalization=True, verbose=False):
        ...
        for epoch in range(epochs):
            ...
            sess.run(iterator.initializer,
                     feed_dict={self.obs_dataset_ph: obs_normalized,
                                self.act_dataset_ph: act_normalized,
                                self.delta_dataset_ph: deltas_normalized})
