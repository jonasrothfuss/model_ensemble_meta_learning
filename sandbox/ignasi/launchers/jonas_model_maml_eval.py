...
def run_eval_task(vv):
    ...
    # env = TfEnv(normalize(env_class(log_scale_limit=0)))


    step_size = 1e-2 #vv['fast_lr']
    ...
    algo = VPG(
            ...
            max_path_length=100,
            n_itr=5,
            optimizer_args={'init_learning_rate': step_size,
                            'tf_optimizer_args': {'learning_rate': step_size},
...
def run_evaluation(argv):
    ...
    parser.add_argument('--num_sampled_envs', type=int, default=3,
    ...
    exp_prefix = os.path.basename(argv[1])
